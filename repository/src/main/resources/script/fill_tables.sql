...
insert into gift_certificate (name, description, price, duration, create_date, last_update_date)
values ('iTunes_gift_card', 'Apple Gift Cards are solely for the purchase of goods and services from the Apple Store, located in iTunes.', 70.00, 50, '2021-08-31T03:12:15.156Z', '2021-08-31T03:12:15.156Z');
